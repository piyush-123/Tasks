...
class oneNeuron(ineuron):
    ...
    def student_welcome(self):
        '''
        this method is used to welcome the students on oneineuron
        courses
        '''

        try:
            self.logger_list.log("Welcome Student", "INFO")
            message = "Hi Students ,welcome to one ineuron"
            return message
...
class instructor(techNeuron):
    ...
    def course_list(self,instructor_name):
        ...
        try:
                self.logger_techNeuron.log("Creating list of courses for an instructor in instructor ", "INFO")
                opt_list = ["Data Science"]
                self.logger_techNeuron.log("Course instructors list  is created and returned ", "INFO")
                return opt_list

        except Exception as e:
            self.logger_techNeuron.log("Creating Course instructors list encountered problem", "ERROR")
...
class student(courses):
    ...
    def sub_course_count(self,main_course_name):
        '''
                this method is used to return the count of  sub courses of students
                course in ineuron portal
        '''

        try:
            self.logger_courses.log("Starting counting of  sub courses for students", "INFO")
            count = 9
            self.logger_courses.log("Sub Course for students count process is completed ", "INFO")
            return count

        except Exception as e:
            self.logger_courses.log("Sub Course Count for students process is failed", "ERROR")
...
class affiliate(instructor):
    ...
    def instructor_skills_update(self, skills):
        '''
        this method is used to update the skills of an affiliate
        '''

        try:
            self.logger_instructor.log("Affiliate skills is being updated", "INFO")
            self.instructor_skills = skills
            self.logger_instructor.log("Affiliate skills are updated ", "INFO")
            return "Hi , Affiliation skills are updated"

        except Exception as e:
            self.logger_instructor.log("Updating Affiliatioon Skill process failed", "ERROR")
...
class lib_neuron(library,ineuron):
    ...
    def lib_courses(self):
            '''
              this method is used to return the courses present in library in one neuron
              '''

            try:
                self.logger_lib.log("Fetching the courses from library in one neuron", "INFO")

                opt = ['Blockchain Community Class',
                       'Data Science']

                self.logger_lib.log("List generated for courses for one neuron ", "INFO")
                return opt

            except Exception as e:
                self.logger_lib.log("Please try Again later!! Not Able to get the course list for one neuron", "ERROR")
