# Sample 10 classes and their Objects to illustrate the classes and objects
...
print("Total student counts are ",i.student_total())
...
t = techNeuron()
print("course list Instructor rahul teaches are ",t.course_list("rahul"))
...
print("Now the total subcourses under data science are ",crs.sub_course_count("data science"))
print("After deleting, total subcourses under data science are ",crs.sub_course_deletion("Data Analytics"))

s = student("ram",9876556789,"ram@gmail.com","121212")
...
afl = affiliate()
print("Is ram eligible for affiliation ",afl.create_affiliate_eligible("Ram"))
print("Affiliation is ready for Ram as ",afl.bank_update(12121212,"ram","icici000999","abcdefghi"))
